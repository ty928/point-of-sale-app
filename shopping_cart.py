...
def lookup_product_by_id(product_id):
    lookup_products = [product for product in products if product["id"] == product_id]
    return lookup_products[0]
...
print("TY928 Store")
print("-------------------------------")
print("Web: www.TY928.com")
print("Phone: 1.222.333.4567")
print("Address:111 NYU Street,New York, NY, 11000")
...
print("-------------------------------")
print("Thanks for your coming! See you next time.")
